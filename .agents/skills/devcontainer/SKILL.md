...
Also check `AGENTS.md` and `docs/adrs/` for documented tech stack decisions.
...
**Developer tooling:**
- Antigravity CLI (pre-install in container?)
- GitHub CLI (`gh`)
...
- Add `.devcontainer/` to the project structure in `AGENTS.md`.
