...
2. **If yes:** The item requires the Architecture Gate (see AGENTS.md § Architecture Gate). Flag it in the plan as "**Requires Architecture Gate:** ADR + Wei debate before implementation."
