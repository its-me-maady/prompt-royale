---
name: vteam-retro
description: Reflect on the work done in this sprint/session. Consider:
---

<!-- agent-notes: { ctx: "kaizen retrospective with GH issues for findings", deps: [docs/methodology/personas.md, AGENTS.md], state: active, last: "grace@2026-02-14" } -->
